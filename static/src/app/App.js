$rmod.def("/src/app/App", function(require, exports, module, __filename, __dirname) { var inherit = require('/$/raptor-util/inherit'/*'raptor-util/inherit'*/);
var AppState = require('./AppState');
var helloService = require('/src/services/hello'/*'src/services/hello'*/);
...
inherit(App, require('/$/events'/*'events'*/).EventEmitter);
